...
class Playassets extends StatefulWidget {
  final String url;
  Playassets(this.url);
  @override
  _PlayassetsState createState() => _PlayassetsState();
}

class _PlayassetsState extends State<Playassets> {
    ...
    return ClipOval(
      child: Material(
        ...
        child: InkWell(
          ...
          onTap: () async {
           await advancedPlayer.setFilePath(this.widget.url);
            advancedPlayer.play();
